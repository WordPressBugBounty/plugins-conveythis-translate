<div class="wrap">
            ...
            <div class="main-block">
                ...
                <style>
                    ...
                    #congrats-modal .celebration-icon {
                        ...
                        border-radius: 50%;
                        animation: congrats-pulse 2s ease-in-out infinite;
                    }
                    ...
                    #congrats-modal .btn-primary:hover {
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <p class="fs-6 lead">
                                    Now that you've chosen your languages, get ready to make your website truly multilingual.</p>
                                <p class="fs-6 lead">
                                    Visit your webpage to
                                    <strong>locate our widget in the lower right corner and experience our translation service by clicking on other languages</strong> ;)
                                </p>
                            </div>
                            <div class="modal-footer d-flex justify-content-center">
                                <button type="button" id="visitSite" class="btn btn-primary" data-bs-dismiss="modal">Visit Site</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="my-5" style="font-size: 14px">
        ...
        <br> If you need any help, you can contact us via our live chat at
        <a href="https://www.conveythis.com/?utm_source=widget&utm_medium=wordpress" target="_blank">www.ConveyThis.com</a> or email us at support@conveythis.com. You can also check our
...
<script>
    jQuery(document).ready(function ($) {
        ...
        setTimeout(function () {
            // $('#congrats-modal').modal('show'); // TEST ONLY
        }, 2000);
